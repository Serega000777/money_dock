...
const WELCOME_TEXT =
  "Добро пожаловать в Amola Finance — личного финансового директора прямо в Telegram.\n\n" +
  "Учитывайте расходы голосом, следите за бюджетом и копите на цели, ничего не открывая, кроме этого чата.\n\n" +
  "Поделитесь номером телефона, чтобы мы могли связаться по важным вопросам аккаунта — это необязательно, можно пропустить.";
